...
// A hardcoded message to be used as the message of the webhook
...
async function addToDB(initOptions){
    ...
    //-------- Create table --------//
    // db.run(`CREATE TABLE IF NOT EXISTS webhooksOptions (id integer primary key, hostname, port, path, method, headers)`);
